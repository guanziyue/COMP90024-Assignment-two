...
# My keys and tokens
consumer_key = 'vxLtsP5U7sfvYfw4SfwqkYdTt'
consumer_secret = 'ulmmDGaIvmpu0h6KUifTBgTUAFtpFWitIApv4ZzvzcLJqHnff3'
access_token = '990534650484310016-of2LLt1BCmeNaA5PaCp6TKdTjkcU1oN'
access_token_secret = 'O8AikOmUwWsAFyokkQCIJs1NWsg9q4Ygqw8RMS3GY7iVZ'
...
class tweetListener(StreamListener):
    ...
    def savetodb(self,data):
        ...
        try:
            db = couch.create('tweet') # create db
        except:
            db = couch['tweet'] # existing
